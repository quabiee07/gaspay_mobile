...
class ThisWeekPortion extends StatefulWidget {
  const ThisWeekPortion({super.key});

  @override
  State<ThisWeekPortion> createState() => _ThisWeekPortionState();
}

class _ThisWeekPortionState extends State<ThisWeekPortion> {
  String? selectedValue;
  List<String> listOfWeeks = ["Week 1", "Week 2", "Week 3", "Week 4"];
              ...
              children: [
                Container(
                  ...
                  child: DropdownButton<String>(
                    ...
                    value: selectedValue,
                    items: listOfWeeks.map<DropdownMenuItem<String>>((value) {
              ...
              children: [
                Expanded(
                  child: ReusableCurrentPriceContainer(
                    ...
                    productStatusContainerColor: const Color(0xFFEAFFEB),
                    productStatusIcon:
              ...
              children: [
                Expanded(
                  child: ReusableCurrentPriceContainer(
                    productName: "Diesel",
                    productPrice: "NGN 1,820/ltr",
                    productStatusContainerColor: const Color(0xFFFFF8EE),
                    productStatusIcon:
