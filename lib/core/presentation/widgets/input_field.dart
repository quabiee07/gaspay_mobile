...
class CardInputField extends TextFieldParent {
  ...
  @override
  TextFieldState createState() => _CardInputFieldState();
}

class _CardInputFieldState extends TextFieldState<CardInputField> {
  @override
  Widget build(BuildContext context) {
    final theme = Theme.of(context);
    return Column(
